    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 100:
                ...
                this.mc.displayGuiScreen(new GuiScreenServerList(this, GuiMultiplayer.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
        }
    }
