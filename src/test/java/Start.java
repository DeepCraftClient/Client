...
public class Start {
    public static void main(String[] args) {
        ...
        Main.main(concat(new String[]{"--version", "MavenMCP", "--accessToken", "AJIJODAIHIUEHUIHGOATZ(/TRZARCJHASIGXCBHYJXBCKDUV", "--assetsDir", "assets", "--assetIndex", "1.8", "--userProperties", "{}"}, args));
    }
